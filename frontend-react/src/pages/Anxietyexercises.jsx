          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mb-3">
                Cada ejercicio utiliza análisis de voz en tiempo real para evaluar tu estado emocional 
                y proporcionarte retroalimentación inmediata. Los ejercicios duran entre 5-15 minutos.
              </p>
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-3">
                <p className="text-sm text-gray-700">
                  <strong className="text-blue-800">Recomendación:</strong> Realiza estos ejercicios en un 
                  lugar tranquilo, con buena iluminación y sin interrupciones para obtener mejores resultados.
                </p>
              </div>
            </div>
          </div>
