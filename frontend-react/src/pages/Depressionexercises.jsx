...
function DepressionExercises() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-100 via-yellow-100 to-orange-100 p-6">
      <div className="max-w-4xl mx-auto">
          ...
          {exercises.map((exercise, index) => (
            ...
            >
              <div className="flex items-start gap-6">
                ...
                {/* Icono */}
                <div className={`w-20 h-20 bg-gradient-to-br ${exercise.color} rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform`}>
        ...
        <div className="mt-8 bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-800 mb-2">¿Cómo funcionan estos ejercicios?</h3>
              <p className="text-sm text-gray-700 mb-3">
                Cada ejercicio utiliza análisis de voz en tiempo real para evaluar tu tono, energía y 
                estado emocional, brindándote retroalimentación personalizada. Los ejercicios duran entre 8-15 minutos.
              </p>
              <div className="bg-amber-50 border-2 border-amber-200 rounded-lg p-3">
                <p className="text-sm text-gray-700">
                  <strong className="text-amber-800">Recomendación:</strong> Practica estos ejercicios por la 
                  mañana para comenzar el día con energía positiva, o cuando sientas que tu ánimo está bajo.
                </p>
              </div>
            </div>
          </div>
