    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-cyan-50 p-4 md:p-6">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="bg-teal-500 text-white px-6 py-2 rounded-full font-bold text-lg shadow-lg">
            GAD-7
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8">
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 mb-3">
              <div 
                className="bg-gradient-to-r from-teal-500 via-green-500 to-teal-500 h-2.5 rounded-full transition-all duration-500"
              ...
              {questions.map((_, index) => (
                <div 
                  ...
                  className={`flex-1 h-1.5 rounded-full transition-colors duration-300 ${
                    ...
                    index === currentQuestion ? 'bg-teal-500' : 
                    'bg-gray-300'
                  }`}
                ></div>
              ))}
          ...
          {/* Pregunta del Test con boton de voz */}
          <div className="mb-8">
                ...
                <button
                  ...
                  className={`flex-shrink-0 p-3 rounded-full transition-all ${
                    isSpeaking 
                      ...
                      : 'bg-teal-100 hover:bg-teal-200 hover:scale-110'
                  }`}
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {voiceTranscript && !showVoiceConfirm && (
                      <p className="text-sm text-emerald-800 italic bg-white/50 px-3 py-2 rounded-lg">
                        {voiceTranscript}
                      </p>
                    )}
                  </div>
